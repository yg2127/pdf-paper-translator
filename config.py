...
# 디렉토리 경로
MODEL_13B_DIR = "/home/yugeon/trained_model/1212-13B/13B_merged_fp16"
yolo_Models_DIR = "/home/yugeon/trans_pipline_1208/yolov11l-doclaynet copy.pt"
FONTS_DIR = "/home/yugeon/trans_pipline_1208/fonts/BMHANNAPro.ttf"
BOLD_FONTS_DIR = "/home/yugeon/trans_pipline_1208/fonts/MaruBuri-Bold.ttf"
INPUT_DIR = "/home/yugeon/PDF_before"
OUTPUT_DIR = "/home/yugeon/PDF_after"
TSV_DIR = "/home/yugeon/trans_pipline_1208/tsv/base_vocab.tsv"

# 기본 설정
DEFAULT_CONFIG = {
    # 입출력 경로 (여기서 수정!)
    "input_pdf": "/home/yugeon/PDF_before/test1.pdf",  # 입력 PDF 경로
    ...
    "korean_bold_font_path": str(BOLD_FONTS_DIR),      # 볼드 TTF 경로 (없으면 일반 폰트 재사용)
    ...
    "terms_output_path": os.path.join(OUTPUT_DIR, "extracted_terms.tsv"),  # 용어 저장 경로
}
